import { GameModel, GameStateBase } from "./model/game";
import { inGunRange as libInGunRange } from "./model/lib";
import { fork, allSettled, scopeBind, serialize } from "effector";
import type { GameSize, GameState, Bot, Dir } from "./model/types";
